...
const Sidebar = () => {
  ...
  return (
    ...
    <div className="w-14 lg:w-20 h-screen shrink-0 flex flex-col border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
      ...
      <div
        className="relative p-3 lg:p-4 border-t border-gray-200 dark:border-gray-700"
        onMouseEnter={() => setIsHover(true)}
        onMouseLeave={() => setIsHover(false)}
      >
        <div
        ...
        >
          <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gray-800 text-white flex items-center justify-center font-semibold">
            {user.name?.charAt(0).toUpperCase()}
          </div>
        </div>
